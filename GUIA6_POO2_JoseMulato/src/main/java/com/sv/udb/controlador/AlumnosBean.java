...
public class AlumnosBean implements Serializable{
    ...
    public void guar()
    {
        ...
        try
        {
            ...
            log4j.info("Alumno Ingresado:"+objeAlum.getNombAlum()+" "+objeAlum.getApelAlum());
            log4j.debug("Depuracion correcta:"+objeAlum);
            this.limpForm();
            ctx.execute("setMessage('MESS_SUCC', 'Atención', 'Datos guardados')");
        }
        catch(Exception ex)
        {
            log4j.warm("Evento inesperado:" +objeAlum);
            log4j.fatal("Evento fatal:" +objeAlum);
            log4j.error("Error al Ingresar el alumno:"+ex);
    ...
    public void modi()
    {
        ...
        try
        {
            ...
            log4j.info("Alumno Modificado: "+objeAlum.getNombAlum()+" "+objeAlum.getApelAlum());
            log4j.debug("Depuracion correcta:"+objeAlum);
        ...
        catch(Exception ex)
        {
            log4j.warm("Evento inesperado:" +objeAlum);
            log4j.fatal("Evento fatal:" +objeAlum);
            log4j.error("Error alumno no modificado"+ex);
    ...
    public void elim()
    {
        ...
        try
        {
            ...
            log4j.info("Alumno Eliminado: "+objeAlum.getNombAlum()+" "+objeAlum.getApelAlum());
            log4j.debug("Depuracion correcta:"+objeAlum);
        ...
        catch(Exception ex)
        {
            log4j.warm("Evento inesperado:" +objeAlum);
            log4j.fatal("Evento fatal:" +objeAlum);
            log4j.error("Error alumno no eliminado"+ex);
    ...
    public void cons()
    {
        ...
        try
        {
            ...
            this.guardar = false;
             log4j.info("Alumno Consultado: " + String.format("%s %s", this.objeAlum.getNombAlum(), this.objeAlum.getApelAlum()));
             log4j.debug("Depuracion correcta:"+objeAlum);
        ...
        catch(Exception ex)
        {
            log4j.warm("Evento inesperado:" +objeAlum);
            log4j.fatal("Evento fatal:" +objeAlum);
            log4j.error("Error alumno no consultado"+ex);
